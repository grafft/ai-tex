...
\newcommand{\blockc}[3]{
	\node[draw, brown, fill=brown, rectangle, pattern = #3, minimum width = #1, minimum height = #2] 
}
...
\newcommand{\obstacle}{
	\blockc{20}{20}{north west lines} at (3.4,-4.5) {};	
...
\newcommand{\situation}{
	...
	\blockc{20}{15}{north west lines} at (6.5,-2) {};				
