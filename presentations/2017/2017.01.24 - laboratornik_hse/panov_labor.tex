...
\addbibresource{panov_labor.bib}
...
\addtobeamertemplate{frametitle}{}{
	\begin{textblock*}{100mm}(\textwidth-10pt,-25pt)
		\includegraphics[width=0.5cm]{misc/logos/hse.png}
	\end{textblock*}
}
...
\begin{document}
	...
	\institute[ПОИС ВШЭ]{Научно-учебная лаборатория\\процессно-ориентированных информационных систем \\Высшая школа экономики}
