...
\addtobeamertemplate{frametitle}{}{
	\begin{textblock*}{100mm}(\textwidth-35pt,-20pt)
		\includegraphics[width=1.5cm]{advert/frccsc.png}
	\end{textblock*}
}
...
\begin{document}
	...
	\institute[ИСА ФИЦ ИУ РАН]{Институт системного анализа\\Федерального исследовательского центра <<Информатика и управление>>\\Российской академии наук}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{column}{0.35\textwidth}
				...
				\node at (-0.5,1.2) {\includegraphics[width=0.5\textwidth]{misc/kudinov}};					
				\node at (-2.8,-1) {\includegraphics[width=0.5\textwidth]{misc/skrynnik}};
				\node at (-0.8,-3) {\includegraphics[width=0.5\textwidth]{misc/chudova}};
				\node at (-3,-2.3) {\includegraphics[width=0.5\textwidth]{misc/miroschnichenko}};
				\end{tikzpicture}
			\end{column}
		\end{columns}		
	\end{frame}	
		...
		\onslide<3->{
			\begin{columns}
				\begin{column}{0.4\textwidth}
					\centering
					\includegraphics[width=0.6\textwidth]{signs/sign_color_book_ru}
				\end{column}
		}
		\onslide<4->{
				\begin{column}{0.6\textwidth}
					\centering
					\includegraphics[width=0.6\textwidth]{phisio/ivan_cyrc}
				\end{column}
			\end{columns}
