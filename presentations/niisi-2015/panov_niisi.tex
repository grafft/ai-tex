		...
		\begin{columns}
			...
			\begin{column}{0.7\textwidth}
				...
				\begin{overlayarea}{\textwidth}{0.5\textheight}
					\only<1>{
						Принимается гипотеза о том, что неокортекс состоит из зон (регионов), состоящих в свою очередь из колонок и имеющих одинаковое строение на всех участках коры. Колонки в регионе объединены латеральными связями. 
					}
