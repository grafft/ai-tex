...
\begin{document}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.6\textwidth}
				\centering
				\includegraphics[width=\textwidth]{agent-schemas/en/strl_rita_eng}
			\end{column}
	...
	\begin{frame}
		...
		\par\bigskip
		\centering
		\includegraphics[width=0.6\textwidth]{misc/pathplan/plan_2}
		\nocite{*}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{column}{0.3\textwidth}
				\centering
				\vspace{10pt}
				\includegraphics[width=\textwidth]{misc/pathplan/plan_lian}
				\vspace{10pt}
				\includegraphics[width=0.5\textwidth]{misc/pathplan/angl_constr_planning}
			\end{column}
		\end{columns}			
		\par\bigskip
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\centering
				\includegraphics[width=\textwidth]{signs/en/sign_colored_rita.pdf}
			\end{column}
			\begin{column}{0.6\textwidth}
				\centering
				\includegraphics[width=0.7\textwidth]{signs/en/sign_kr.png}
			\end{column}
		\end{columns}
	...
	\begin{frame}
		...
		\centering
		\includegraphics[page=1,width=0.6\textwidth]{sign-schemas/oper_relat}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\centering
				\includegraphics[page=2,width=\textwidth]{sign-schemas/oper_relat}
				
				Linking a significance and a meaning.
			\end{column}
			\begin{column}{0.5\textwidth}
				\centering
				\includegraphics[page=3,width=\textwidth]{sign-schemas/oper_relat}
	...
	\begin{frame}
		...
		\centering
		\includegraphics[width=0.5\textwidth]{sign-schemas/sign_naming_colored}
	\end{frame}		
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.3\textwidth}
				\begin{figure}
					\includegraphics[width=0.7\textwidth]{signs/en/sign_colored_en}
					\par\bigskip
					\includegraphics[width=\textwidth]{misc/mpf/info_flow}
				\end{figure}
			\end{column}
			\begin{column}{0.7\textwidth}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=0.9\textwidth]{misc/phisio/neuro_htm}
		\end{center}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\includegraphics[width=0.9\textwidth]{misc/mpf/hierarchy}
			\end{column}
			\begin{column}{0.5\textwidth}
				\includegraphics[width=0.9\textwidth]{misc/mpf/hierarchy_conv}
			\end{column}
		\end{columns}
	...
	\begin{frame}
		...
		\par\bigskip
		$S \leftrightarrow F$ --- naming process.
		\par\bigskip
		\[s=\langle p,m,a\rangle\]	
		$p$ -- is the set of features included into prediction matrices of sign $s$,	
		
		$m$ -- is the set of features which includes the sign $s$ into its matrices,
		
		$a$ -- the same as $m$ but includes personal embodied features.
	\end{frame}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.7\textwidth}
				\includegraphics[width=\textwidth]{algo/en/beh_plan-0.png}
			\end{column}
			\begin{column}{0.3\textwidth}
				\tiny
