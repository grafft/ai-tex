...
\begin{document}
	...
	\begin{frame}
		...
		\begin{Def}
			Если $f_1$ "--- признак, обозначающий знаку $s_1$, то подмножество $\tilde p(f_1)$ множества $\mathcal F$ таких признаков, что $\forall f_i\in\tilde p(f_1) f_i\sqsubset f_1$, будем называть образом знака $s_1$ (признака $f_1$).
		\end{Def}
	...
	\begin{frame}
		...
		\begin{Def}
			Если $f_1$ "--- признак, обозначающий знаку $s_1$, $f_2$ "--- процедурный признак и $f_1\sqsubset^c f_2$, то будем называть $f_2$ значением знака $s_1$ (признака $f_1$). Множество всех значений признака $f_1$ будем обозначать $\tilde m(f_1)$.
		\end{Def}
