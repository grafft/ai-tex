...
\begin{document}
	...
	\title[Основания знаковой КМ]{Нейрофизиологические основания знаковой картины мира}
	\author[Панов]{Александр Панов}
	\institute[ИСА РАН]{ИСА РАН}
	\date{6 апреля 2015~г.} 
	
	\begin{frame}
		\titlepage
	\end{frame}
	
	\section{Модели Шумского}
	
	\begin{frame}
		\frametitle{Глобальная архтектура}
		
		
	\end{frame}
	
	\section{ART Гроссберга}
	\begin{frame}
