...
\usepackage{hyperref}			% Русский язык для оглавления pdf
...
\graphicspath{{../../images/misc/oop/}} 			% Пути к изображениям
...
\defverbatim[colored]\lstAgregationP{%
	\begin{lstlisting}[language=python]
class Fish:
...
\defverbatim[colored]\lstAssociationP{%
	\begin{lstlisting}[language=java]
class Programmer:
	def __init__(self, computers):
		self.__computers = computers
class Computer:
	def __init__(self, programmers):
