...
\begin{document}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.33\textwidth}
				\begin{figure}
					\includegraphics[width=\textwidth]{phisio/mozg_2}
				\end{figure}
	...
	\begin{frame}
		...
		\begin{enumerate}
			\item Построена модель компонент знака "--- элемента картины мира субъекта деятельности в рамках сегодняшних представлений о строении мозга и психики человека.
