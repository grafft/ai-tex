...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item на основе построенной модели разработать итерационный алгоритм формирования двух основных компонент знака: образа и значения;
	...
	\begin{frame}
		...
		\par\bigskip
		В работе построен итерационный алгоритм $\mathfrak A_{pm}$ доопределения функции $\Psi_p^m$, который обеспечивает формирование такого образа из множества признаков $\hat F$, при котором формируемое значение знака сходится к заданному значению $\tilde m^0=\{f_p\}$.
	\end{frame}
