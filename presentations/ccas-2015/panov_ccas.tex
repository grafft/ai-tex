...
\begin{document}
	...
	\begin{frame}
		...
		По нейрофизиологическим данным (В.~Маунткасл,1981; Дж.~Хокинс, 2009; С.~Гроссберг, 2014), в том числе в \textit{теории повторного входа} или \textit{информационного синтеза} (Д.~Эдельман, 1987; А.\,М.~Иваницкий, 2010) возникновение ощущения, т.~е. активизация некоторого элемента картины мира субъекта, происходит при замыкании контура распространения нервного возбуждения от сенсорного входа. 
	\end{frame}
	...
	\begin{frame}
		...
		\par\bigskip
		По Леонтьеву образующими картины мира, т.~е. компонентами знака, являются \textit{образ}, \textit{значение} и \textit{личностный смысл}.
	\end{frame}
