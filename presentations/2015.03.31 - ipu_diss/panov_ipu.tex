...
\begin{document}
	...
	\begin{frame}
		...
		\end{Def}
		В множестве операторов $\mathcal R$ введём операции умножения на скаляр, сложения и умножения. Пусть $r'$ "--- скаляр, $R',R''\in\mathcal R$. Определим операторы $r'{\cdot}R'$ и $R'+R''$ следующим образом:
		\begin{equation}
