...
\firstname{Aleksandr} % Your first name
...
%\extrainfo{additional information}admin
...
\section{Grants and Team Responsibilities}
...
\nocite{*}
\printbibliography[title={Selected Publications}, keyword={mypubtr}, resetnumbers=true]
