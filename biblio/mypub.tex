...
%	\printbibliography
	...
	\begin{refsection}
		\nocite{*}
		\printbibliography[title={Публикации, индексируемые в Web of Science (Core Collection)}, heading=subbibliography, keyword={wos{\_}core},check=recent, resetnumbers=true]
	\end{refsection}
	...
	\begin{refsection}
		\nocite{*}
		\printbibliography[title={Публикации, индексируемые в Scopus и Web of Science (Core Collection)}, heading=subbibliography, keyword={scopus,wos{\_}core},check=recent, resetnumbers=true]
	\end{refsection}
	\par
\end{document} 	