...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (a) at (-96 pt, -50 pt){};
		\predmatr{-100}{-50}{a1}
		\node at (-80 pt, -35 pt) {``a''};
		
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (b) at (-36 pt, -50 pt){};
		\predmatr{-40}{-50}{b1}
		\node at (-20 pt, -35 pt) {``b''};
		
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (c) at (34 pt, -50 pt){};
		\predmatr{30}{-50}{c1}
		\node at (50 pt, -35 pt) {``c''};
		
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (d) at (114 pt, -50 pt){};
		\predmatr{110}{-50}{d1}
		\node at (130 pt, -35 pt) {``d''};
		...
		\path[-latex', ] ([xshift=-5]a.north) edge [bend left, out = 50, in = 180] node[above, black, xshift=8] {\scriptsize 4} node[above, black, very near start] {\scriptsize 1} ([xshift=-4]goal1.south);

		\path[-latex', ] ([xshift=-5]b.north) edge [bend left, out = 50, in = 180] node[above, black, near end] {\scriptsize 1} node[left, black, very near start] {\scriptsize 1} ([xshift=-4]on1.south);
		\path[-latex', ] ([xshift=5]b.north) edge [bend left, out = 50, in = 210] node[above, black] {\scriptsize -1} node[left, black, very near start] {\scriptsize 1} ([xshift=4]on2.south);
		...
		\path[-latex', ] ([xshift=7]c.north) edge [bend right, out = -40, in = 180] node[above, black] {\scriptsize -1} node[right, black, near start] {\scriptsize 1} ([xshift=4]on3.south);
		...
		\path[-latex', ] ([xshift=7]d.north) edge [bend right, out = -50, in = 150] node[above, black, near end] {\scriptsize 5} node[above, black, very near start] {\scriptsize 1} ([xshift=-2]goal1.south);
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (d) at (124 pt, -50 pt){};
		\predmatr{120}{-50}{d1}
		\node at (140 pt, -35 pt) {``d''};
		...
		\path[-latex'] ([xshift=5]a.north) edge [out = 90, in = -160] node[below, black, near end] {\scriptsize 2} node[above, black, very near start] {\scriptsize 1} ([yshift=-6]start1.west);
		
		\path[-latex'] ([xshift=-5]b.north) edge [out = 90, in = -140] node[above, black, near end] {\scriptsize 3} node[above, black, near start] {\scriptsize 1} ([xshift=-4]start1.south);
		\path[-latex'] ([xshift=5]b.north) edge [out = 90, in = -130] node[below, black, near end] {\scriptsize 4} node[above, black, very near start] {\scriptsize 1} ([xshift=-2]start1.south);
		
		\path[-latex'] ([xshift=-5]c.north) edge [out = 90, in = -100] node[left, black, near end] {\scriptsize 5} node[above, black, near start] {\scriptsize 1} ([xshift=-4]start1.south);
		\path[-latex'] ([xshift=5]c.north) edge [out = 90, in = -100] node[right, black, near end] {\scriptsize 6} node[above, black, very near start] {\scriptsize 1} ([xshift=-2]start1.south);
		
		\path[-latex'] ([xshift=-5]d.north) edge [out = 90, in = -60] node[left, black, near end] {\scriptsize 7} node[above, black, near start] {\scriptsize 1} ([xshift=-1]start1.south);
		\path[-latex'] ([xshift=5]d.north) edge [out = 90, in = -60] node[right, black, very near end] {\scriptsize 8} node[above, black, very near start] {\scriptsize 1} ([xshift=0]start1.south);
		
		\path[-latex'] ([xshift=-10]clear.south) edge [out = -70, in = 190] node[above, black, very near end] {\scriptsize 1} node[above, black, near start] {\scriptsize 1} ([yshift=-2]start1.west);
		\path[-latex'] ([xshift=-5]clear.south) edge [out = -70, in = 180] node[above, black, near end] {\scriptsize 3} node[above, black, very near start] {\scriptsize 2} ([yshift=0]start1.west);
		\path[-latex'] ([xshift=10]clear.south) edge [out = -50, in = 150] node[above, black, near end] {\scriptsize 5} node[above, black, near start] {\scriptsize 3} ([yshift=4]start1.west);
		\path[-latex'] ([xshift=5]clear.south) edge [out = -60, in = 170] node[above, black, near end] {\scriptsize 7} node[above, black, very near start] {\scriptsize 4} ([yshift=2]start1.west);
		
		\path[-latex'] ([xshift=-15]ontable.south) edge [out = -90, in = 90] node[above, black, very near end] {\scriptsize 2} node[above, black, near start] {\scriptsize 1} ([xshift=-6]start1.north);
		\path[-latex'] ([xshift=-5]ontable.south) edge [out = -90, in = 80] node[above, black, near end] {\scriptsize 4} node[above, black, near start] {\scriptsize 2} ([xshift=-4]start1.north);
		\path[-latex'] ([xshift=5]ontable.south) edge [out = -90, in = 70] node[above, black, near end] {\scriptsize 6} node[above, black, near start] {\scriptsize 3} ([xshift=-2]start1.north);
		\path[-latex'] ([xshift=15]ontable.south) edge [out = -90, in = 60] node[above, black, near end] {\scriptsize 8} node[above, black, near start] {\scriptsize 4} ([xshift=0]start1.north);
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 20, minimum width = 40] (bt) at (2.5 pt, 0 pt){};
		\predmatr{0}{0}{newact}
		\node at (30 pt, 20 pt) {``build tower''};
		
		\node[ell, ellipse, minimum height = 20, minimum width = 40] (aot) at (-37.5 pt, -50 pt){};
		\predmatr{-40}{-50}{c1}
		\node at (-40 pt, -67 pt) {``start'' $\rightarrow$ ``all on table''};		
		
		\node[ell, ellipse, minimum height = 20, minimum width = 40] (t) at (42.5 pt, -50 pt){};
		\predmatr{40}{-50}{d1}			
		\node at (60 pt, -67 pt) {``goal'' $\rightarrow$ ``tower''};	
		
		\path[-latex'] (aot.north) edge [out = 100, in = -140] node[above, black] {\scriptsize 1} node[above, black, very near start] {\scriptsize 1} ([xshift=-3]newact.south);
		\path[-latex'] (t.north) edge [out = 100, in = -70] node[above, black] {\scriptsize -1} node[above, black, very near start] {\scriptsize 1} ([xshift=3]newact.south);		
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 20, minimum width = 40] (aot) at (-37.5 pt, -50 pt){};
		\predmatr{-40}{-50}{c1}
		\node at (-40 pt, -67 pt) {``pick-up''};		
		
		\node[ell, ellipse, minimum height = 20, minimum width = 40] (t) at (42.5 pt, -50 pt){};
		\predmatr{40}{-50}{d1}			
		\node at (60 pt, -67 pt) {``stack''};	
		...
		\path[-latex'] (aot.north) edge [out = 100, in = -140] node[above, black] {\scriptsize 3} node[above, black, very near start] {\scriptsize 1} ([xshift=-3]newact.south);
		\path[-latex'] ([xshift=7]aot.north) edge [out = 30, in = 0] node[right, black, very near end] {\scriptsize -2} node[right, black, very near start] {\scriptsize 1} ([yshift=-3]newact.east);
		
		
		\path[-latex'] ([xshift=-7]t.north) edge [out = 140, in = 180] node[left, black, very near end] {\scriptsize 2} node[above, black, very near start] {\scriptsize 1} ([yshift=-3]newact.west);
		\path[-latex'] (t.north) edge [out = 90, in = -70] node[above, black] {\scriptsize -1} node[above, black, very near start] {\scriptsize 1} ([xshift=3]newact.south);
		\path[-latex'] ([xshift=7]t.north) edge [out = 90, in = 0] node[above, black] {\scriptsize -3} node[right, black, very near start] {\scriptsize 1} ([yshift=3]newact.east);		
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (d) at (94 pt, -50 pt){};
		\predmatr{90}{-50}{d1}
		\node at (110 pt, -35 pt) {``d''};
		
		\node[ell, ellipse, minimum height = 25, minimum width = 40] (e) at (154 pt, -50 pt){};
		\predmatr{150}{-50}{e1}
		\node at (170 pt, -35 pt) {``e''};
		...
		\path[-latex', ] ([xshift=-7]d.north) edge [bend right, out = -50, in = 140] node[above, black] {\scriptsize 1} node[above, black, very near start] {\scriptsize 1} ([xshift=-4]on3.south);
		\path[-latex', ] ([xshift=7]d.north) edge [bend right, out = -50, in = 150] node[above, black, near end] {\scriptsize -1} node[above, black, very near start] {\scriptsize 1} ([xshift=4]on4.south);
		
		\path[-latex', ] ([xshift=-7]e.north) edge [bend right, out = -50, in = 150] node[above, black] {\scriptsize 1} node[above, black, very near start] {\scriptsize 1} ([xshift=-4]on4.south);
		\path[-latex', ] ([xshift=7]e.north) edge [bend right, out = -50, in = 150] node[above, black, near end] {\scriptsize 6} node[above, black, very near start] {\scriptsize 1} ([xshift=-2]goal1.south);
		
		\path[-latex', ] ([xshift=5]on.north) edge [out = 100, in = 180] node[left, near end, black, xshift=1] {\scriptsize 1} node[left, black,very near start, xshift=1] {\scriptsize 1} ([yshift=-4]goal1.west);
		\path[-latex', ] ([xshift=-5]on.north) edge [bend right, out = 90, in = 120] node[above, black] {\scriptsize 2} node[above, black, near start] {\scriptsize 2} ([yshift=0]goal1.west);
		\path[-latex', ] ([xshift=-15]on.north) edge [bend right, out = 90, in = 120] node[above, black] {\scriptsize 3} node[above, black, near start] {\scriptsize 3} ([yshift=4]goal1.west);	
		
		\path[-latex', ] (clear.west) edge [out = 180, in = 90] node[above, black, near end] {\scriptsize 6} node[above, black, near start] {\scriptsize 1} ([xshift=-2]goal1.north);		
		\path[-latex', ] (ontable.east) edge [bend right, out = 20, in = 120] node[above, black, near end] {\scriptsize 4} node[above, black, near start] {\scriptsize 1} ([xshift=-4]goal1.north);			
	\end{tikzpicture}	
\end{document}