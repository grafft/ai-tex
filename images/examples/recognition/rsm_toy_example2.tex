...
\begin{tikzpicture}[scale=.9,every node/.style={minimum size=1cm},on grid]          
    ...
    \node[font=\Large] at (-5,2.7) {Input image};
    \node[font=\Large] at (-3.3,6) {Layer 1};
    \node[font=\Large] at (-1.7,8.5) {Layer 2};
    \node[font=\Large] at (-1,10) {Bayes classificator};
    \node[font=\Large] at (4.7,0.2) {Shift over time};
\end{tikzpicture}
