...
\begin{document}
	\begin{tikzpicture}[>=triangle 60]
		...
		\node[align=center] at (-50pt, -60pt) {Angle=True\\$Pos_x$=<<слева>>\\${Pos_y}$=<<внизу>>};
		\node[align=center] at (50pt, 60pt) {Angle=True\\$Pos_x$=<<слева>>\\${Pos_y}$=<<сверху>>};
		\node[align=center] at (-50pt, 60pt) {Angle=True\\$Pos_x$=<<справа>>\\${Pos_y}$=<<сверху>>};
		\node[align=center] at (50pt, -60pt) {Angle=True\\$Pos_x$=<<справа>>\\${Pos_y}$=<<внизу>>};
