...
\begin{document}
	...
	\begin{tikzpicture}[>=triangle 60]
		...
		\draw[<-] ([yshift=-3mm]integr_3.east) -- node[align = center, below] {управляющий\\сигнал и\\параметры движения} ([yshift=-3mm]signal_3.west);
		...
		\draw[->,rounded corners] (build_tr.east) -| node[align=center,yshift=-50mm,right] {желаемая\\траектория и\\параметры движения} ([xshift=10mm]signal_3.north);
