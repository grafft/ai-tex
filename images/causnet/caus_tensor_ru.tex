...
\begin{document}
	...
	\node[align=center, font=\small] at ($(z_l_ex1)+(0,-70pt)$) {время $\bar t_c \cup \bar t_e$};
	\node[align=center, rotate=-35, font=\small] at ($(z_l_ex1)+(-65pt,-57pt)$) {прецеденты $\bar \tau$};
	\node[align=center, rotate=90, font=\small] at ($(z_l_ex1)+(70pt,0pt)$) {признаки $\bar n$};
