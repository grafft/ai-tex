...
\begin{document}
	...
	\begin{tikzpicture}[join=round,scale=3.0,node distance = -0.05]
		...
		\node[align=center,font=\footnotesize] at (-10pt,-23pt) {матрицы\\предсказания $Z_m$};		
		...
		\node[align=center,font=\footnotesize] at (60pt,-23pt) {матрицы\\предсказания $Z_p$};
		...
		\node[align=center,font=\footnotesize] at (25pt,-30pt) {матрицы\\предсказания $Z_p$};
