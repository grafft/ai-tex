...
\begin{document}
	...
	\begin{tikzpicture}[join=round,scale=3.0,node distance = -0.05]
		...
		\node[align=center,font=\footnotesize] at (-10pt,-23pt) {каузальные\\матрицы $Z_m$};		
		...
		\node[align=center,font=\footnotesize] at (60pt,-23pt) {каузальные\\матрицы $Z_p$};
		...
		\node[align=center,font=\footnotesize] at (25pt,-30pt) {каузальные\\матрицы $Z_p$};
		...
		\node[align=center] at (55pt,29pt) {лингвистические\\отношения};
		\node[align=center] at (60pt,2pt) {уровень\\когнитивных функций};
		...
		\node[align=center] at (20pt,-60pt) {нейронный субстрат};
		
		\draw [decorate,decoration={brace,amplitude=10pt}]
		(70 pt,-5pt) -- (70pt,-50pt) node [black,midway, align=center, xshift=20pt, rotate=90] {означивание};
	\end{tikzpicture}
