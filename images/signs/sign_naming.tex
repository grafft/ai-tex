...
\begin{document}
	...
	\begin{tikzpicture}[join=round,scale=3.0,node distance = -0.05]
		...
		\node[sign_comp, dash pattern=on 0.9 off 0.9] (s_p) at (0.0,0.2) {};
		\node[sign_comp, dash pattern=on 0.9 off 0.9] (s_m) at (1.0,0.2) {};
		\node[sign_comp] (s_n) at (0.5,1.0) {};
		\node[sign_comp, dash pattern=on 0.9 off 0.9] (s_a) at (0.7,0.0) {};
		...
		\node[proto_comp] (perc) at (-0.2,0.0) {};
		\node[proto_comp] (bio) at (0.7,-0.3) {};
		\node[proto_comp] (func) at (1.2,0.0) {};
