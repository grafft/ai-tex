...
\begin{document}
	...
	\begin{tikzpicture}[join=round,scale=3.0,node distance = -0.05]
		...
		\node[align=center,font=\footnotesize,fill=white,opacity=0.8,text opacity=1] at (50pt,-15pt) {prediction\\matrices\\$Z_m$};		
		...
		\node[align=center,font=\scriptsize] at ($(z_l_a)+(19pt,-8pt)$) {effective\\feature\\$f_2$};
		\node[align=center,font=\scriptsize] at ($(z_l_a)+(-23pt,-6pt)$) {condition\\feature\\$f_1$};
