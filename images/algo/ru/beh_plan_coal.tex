...
\begin{document}
	...
	\begin{tikzpicture}
		\situation{st}{0}{0};
		\node[align=center] at (-1.2,0) {начальная\\ситуация};
		\situation{end}{200}{0};
		\node[align=center] at (6,-0.2) {целевая\\ситуация};
		...
		\node[align=center, color=blue] at (8,-0.4) {$M$-шаг};
		\node[align=center, color=green!70!black] at (7.6,-0.8) {$A$-шаг};
		\node[align=center, color=red] at (7.2,-1.2) {$P$-шаг};
		\draw [decorate,decoration={brace,amplitude=3pt,mirror}]
		(8.8,-1.5) -- (8.8,-0.1) node[align=center,midway,font=\small,xshift=23pt] {$MAP$\\итерация};
		\node[align=center] at (4.6,-1.2) {новая\\текущая\\ситуация};
		
		\node[align=center, color=blue] at (6.5,-1.8) {$M$-шаг};
		\node[align=center, color=green!70!black] at (6.2,-2.2) {$A$-шаг};
		\node[align=center, color=red] at (5.8,-2.6) {$P$-шаг};
		\draw [decorate,decoration={brace,amplitude=3pt,mirror}]
		(7.4,-2.8) -- (7.4,-1.6) node[align=center,midway,xshift=25pt] {$MAP$\\итерация};		
		\node[align=center] at (85pt,-75pt) {новая\\текущая\\ситуация};

		\node[align=center, color=blue] at (140pt,-95pt) {$M$-шаг};
		\node[align=center] at (115pt,-110pt) {$\cdots$};

		\node[align=center] at (100pt,-135pt) {$\cdots$};
		\node[align=center, color=red] at (95pt,-145pt) {$P$-шаг};
		
		\node[align=center] at (80pt,-25pt) {$S$-шаг};

		
		\node[align=center, text=green!70!black] (ppo) at (0pt,-80pt) {автоматизированные\\операции};
		...
		\draw[->] ([xshift=-5pt]ppo.north) to[out=90,in=-90] node[align=center,left, font=\small]{обновление\\ситуации} (sit_st);
