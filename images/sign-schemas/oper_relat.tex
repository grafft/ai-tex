\documentclass[tikz,border=3pt,convert={density=600,outext=.jpg}]{standalone}
...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node at (5,3) {$Con$};
		\node[ell, circle, minimum size = 40] (c_1) at (5, 1) {$\mathcal{P}_c(r_1)$};
		\node[ell, circle, minimum size = 40] (c_2) at (5, -1) {$\mathcal{P}_c(r_2)$};
		...
		\node at (2.5, -3) {$m=\{r|\mathcal{P}_c(r)\subseteq\mathcal{P}(p_i)\}$};
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 150, minimum width = 80] (p) at (0,0){};
		\node at (0,3) {$Con$};
		\node[ell, circle, minimum size = 40] (p_1) at (0, 1) {$\mathcal{P}_c(r_1)$};
		
		\node[ell, circle, minimum size = 40] (p_2) at (0, -1) {$\mathcal{P}_c(r_2)$};
		...
		\node at (5.3,2) {$\mathcal{P}_c(r_1^*)$};
		\node at (5.3,0) {$\mathcal{P}_c(r_2^*)$};
		...
		\node[align=center] at (2.5, -3) {$\forall r^*\exists r\ Con(r)\cap Con(r^*)\not = \varnothing$\\
	...
	\begin{tikzpicture}
		...
		\node[ell, ellipse, minimum height = 150, minimum width = 80] (p) at (0,0){};
		\node at (0,3) {$Con$};
		\node[ell, circle, minimum size = 40] (p_1) at (0, 1) {$\mathcal{P}_a(r_1^*)$};
		
		\node[ell, circle, minimum size = 40] (p_2) at (0, -1) {$\mathcal{P}_a(r_2^*)$};
		...
		\node at (2.5, -3) {$P=\bigcup_j\mathcal{P}_a(r_j^*)$};
	\end{tikzpicture}
